...
5. [Пример использования в backtrader](#пример-использования-в-_backtrader_)
6. [Справка по новым функциям](#справка-по-новым-функциям)
...
* 22 - добавляем полученный источник данных с котировками фьючерсного контракта в движок `cerebro`.
